...
class _PetDetailsState extends State<PetDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(widget.pet.name.toUpperCase(),
        ...
        actions: [
          IconButton(
            onPressed: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => EditPetProfile(pet: widget.pet))),
      ...
      body: Stack(
        children: [
          Positioned(
              ...
              child: SizedBox(
                  height: height*0.50,
                    child: Image.network(widget.pet.imageUrl, fit: BoxFit.cover,)
                  )
          ),
          Positioned(
            child: Container(
                    ...
                    top: 100,
                      ...
                      child: SizedBox(
                        child: Column(
                          ...
                          children: [
                            PetFeature(widget: widget, feature: 'Name', text: widget.pet.name,),
                            PetFeature(widget: widget, feature: 'Age', text: widget.pet.age.toString()+' years old',),
                          ],
                        ),
                      )),
                ],
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 15),
                    Expanded(child: Text(widget.pet.description,
            ...
            Expanded(
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                      child: Text(widget.pet.name.toUpperCase()+'\'S FENCE',
                      style: TextStyle(
...
class PetFeature extends StatelessWidget {
  ...
  const PetFeature({
    super.key,
    required this.widget, required this.feature, required this.text
  });
