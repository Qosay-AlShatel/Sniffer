...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  void initState() {
    super.initState();
    _firstNameController.text = _currentUser.displayName?.split(' ').first ?? '';
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                            if (value!.isNotEmpty && !RegExp(r"[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?")
                                    .hasMatch(value!)) {
